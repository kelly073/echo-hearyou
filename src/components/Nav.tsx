  ...
  return (
    <nav className="flex items-center justify-between w-full max-w-3xl mb-6">
      <Link href="/" className="flex items-center gap-2">
        <div className="h-8 w-8 rounded-2xl bg-sky-500 flex items-center justify-center text-white text-sm font-semibold shadow-md shadow-sky-200">
          M
        </div>
        <div className="flex flex-col leading-tight">
          <span className="text-sm font-semibold text-slate-800">Mirror</span>
